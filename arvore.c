...
// Funções de exibição
void exibir_pre_ordem(NoArv *raiz) { // Visita o nó atual antes dos nós filhos
                                     // (esquerda e direita).
  if (raiz) {
    printf("%d ", raiz->valor);
...
void exibir_in_ordem(NoArv *raiz) { // Visita o nó esquerdo, depois o nó atual e
                                    // depois o nó direito.
  if (raiz) {
...
void exibir_pos_ordem(NoArv *raiz) { // Visita os nós filhos (esquerda e
                                     // direita) antes de visitar o nó atual.
  if (raiz) {
